...
const TVShowGrid = ({ shows, title, showWatchlistButton = true }) => {
    ...
    return (
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        <div className="text-center py-8 sm:py-12 md:py-16">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">No TV shows found</h3>
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
      ...
      {/* Enhanced Responsive TV Show Grid */}
